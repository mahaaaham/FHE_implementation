...
width=2cm, minimum height = 0.0cm}}
	...
	\node[rect] (LXOR2) at (1.5,-9) {LXOR2};
	\node[rect] (RXOR2) at (7.5,-9) {RXOR2};
	\node[rect] (MXOR2) at (4.5,-11) {MXOR2};
	...
	\node[encoding, above = 0 of A] (Ae) {};
	\node[encoding, above = 0 of B] (Be) {};
	\node[encoding, above = 0 of C] (Ce) {};
	\node[encoding, above = 0 of D] (De) {};
	...
	\node[encoding, above = 0 of W] (Wei)  {};
	\node[encoding, above = 0 of X] (Xei)  {};
	\node[encoding, above = 0 of Y] (Yei)  {};
	\node[encoding, above = 0 of Z] (Zei)  {};

	\node[encoding, below = 0 of W] (Weo)  {};
	\node[encoding, below = 0 of X] (Xeo)  {};
	\node[encoding, below = 0 of Y] (Yeo)  {};
	\node[encoding, below = 0 of Z] (Zeo)  {};
	...
	\foreach \item in {Ae,Be,Ce,De}
	\draw (\item) -- ($(\item) + (0,1)$);

	\draw[->] (MXOR2eo) -- ($(MXOR2) - (0,1)$);

	% number above, under and in the sides of the boxs
	\foreach  \item in {MB1e, MB2e, MB3e, MB4e, Weo, Xeo, Yeo, Zeo}
	...
	\foreach  \item in {Wei, Xei, Yei, Zei}
