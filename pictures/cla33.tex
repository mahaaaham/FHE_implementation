...
\newcommand{\makebigredline}[4]{
\draw[-, very thick, dashed, red]   ($(#1) + (#2,#3)$) -- ($(#1) + (#2 + #4,#3)$);
}
...
\makebigline{b4}{\hlineind}{2 * \vlineind}{2 * \hshift - 0.15}
...
\makebigredline{b0}{\hlineind}{3 * \vlineind}{4 * \hshift - 0.15}
