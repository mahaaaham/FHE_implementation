\begin{section}{Analyse du cryptosystème: sécurité, profondeur des circuits}
	...
	lwe\_estimator est un module de sagemath destiné à estimer la
	résistance face à diverses attaques de paramètres précis pour
	le problème de learning with error. De plus, il propose aussi des
	familles de paramètres, dont ceux de Regev et de LindnerPeikert.
	
	\begin{subsubsubsection}{quelques choix de paramètres}
		regev, proposé dans machin DIRE QUE C T PAS SI PRECIS , il vaut
		ci: VALEUR PRECISE
		linderpeikert: 
	\end{subsubsection}
	\begin{subsubsubsection}{estimate\_lwe}
	...
	METTRE UN LSTLISTING OU TU COPIES UNE SORTIE AVEC UTILISATION
