\begin{section}{Analyse du cryptosystème: sécurité, profondeur des circuits}
	...
	\begin{subsubsubsection}{quelques choix de paramètres}
	 Sachant que sagemath met à disposition des familles de paramètres,
	dont ceux de Regev et ceux de LindnerPeikert, ce qui évite d'avoir à les calculer soi même.
	...
	\path{lwe\_estimator} (SITE WEB https://bitbucket.org/malb/lwe-estimator) est un module de sagemath
