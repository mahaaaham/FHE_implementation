...
% Notons que pour faire un FHE, il suffit d'avoir des paramètres qui permettent assez de profondeur pour faire 2 fois le
% circuit de déchiffrement ainsi qu'un NAND. De cette façon, on peut faire autant de fois que souhaité le circuit \[
