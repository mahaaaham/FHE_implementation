...
$8 \lceil \log_2(s) \rceil + 36\lceil\log_3(nb)\rceil -18$. Soit, une profondeur en $\mathcal{O}(\log_2(nb) + \log_2(s))$.
\end{prop}
...
\[88 \lceil \log_2(\log_2(q)) \rceil + 36 \log\left(n)\right) \]
...
*(n+1)\right) = 16 \lceil \log_2(\log_2(q)) \rceil + 72 \log_3(\log_2(q)) + 36 \log_3\left((n+1)\right) \]
