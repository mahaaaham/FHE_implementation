...
% Dans cette section, nous considérons un cryptosystème asymétrique avec une
% fonction supplémentaire $\Eval$:
...
% \end{itemize}
% Il va nous servir de base pour définir différentes notions.
