...
void 
compare_bit(LweSample* result, const LweSample* a, const LweSample* b, 
...
void 
minimum(LweSample* result, const LweSample* a, const LweSample* b, 
	const TFheGateBootstrappingCloudKeySet* bk) 
{
...
void 
sum(LweSample* result, const LweSample* a, const LweSample* b, 
    const TFheGateBootstrappingCloudKeySet* bk) 
{
  const int nb_bits = 16;
